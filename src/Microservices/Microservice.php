...
use Microservices\Tools\apiProxy;
...
//     * @return Answer
//     */
//    public function sendRequest($request, $address)
//    {
//        $answer = new Answer();
//        $client = new Client();
//
...
//    }
    ...
    public function apiHelloWorld($question)
    {
        $answer = new Answer();

        if (!empty($question->name)) {
            $answer->message = 'Hello world, ' . $question->name;
        } else {
